...
-(void)rj_setTableViewCell{
    ...
    UILabel *authorLabel = [RJInitViewTool rj_initLabelWithSuperView:self text:@"J. K. Rowling" font:rj_kFont_36 textColor:rj_kColor_333333];
    ...
    UILabel *introductionLabel = [RJInitViewTool rj_initLabelWithSuperView:self text:@"Harry Potter is a series of seven fantasy novels written by the British author J. K. Rowling.The books chronicle the adventures of the adolescent wizard Harry Potter and his best friends Ron Weasley and Hermione Granger, all of whom are students at Hogwarts School of Witchcraft and Wizardry." font:rj_kFont_36 textColor:rj_kColor_333333];
