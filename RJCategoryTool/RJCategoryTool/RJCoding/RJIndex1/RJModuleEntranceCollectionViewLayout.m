//
//  RJModuleEntranceCollectionViewLayout.m
//  RJCategoryTool
//
...
@interface RJModuleEntranceCollectionViewLayout ()
@property (nonatomic, strong) NSArray <UICollectionViewLayoutAttributes *> *allAttributes;
@end

@implementation RJModuleEntranceCollectionViewLayout
- (void)_commonInit {
    self.columns = 5;
    self.rows = 2;
    self.itemSize = CGSizeMake(rj_kScreenWidth/5, 80);//CGSizeMake(64, 64);
