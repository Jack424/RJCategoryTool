...
#ifndef RJCategoryTool_h
#define RJCategoryTool_h
...
/*
 pod 'UMengUShare/Social/ReducedWeChat', '~> 6.4.8.2'
 pod 'UMengUShare/Social/ReducedQQ', '~> 6.4.8.2'
 pod 'UMengUShare/Social/ReducedSina', '~> 6.4.8.2'
 ...
 <string>以便拍照、使用扫一扫等功能</string>
 <key>NSContactsUsageDescription</key>
 <string>以便快速填写联系人信息</string>
 <key>NSLocationAlwaysUsageDescription</key>
 <string>以便获取附近的商品信息</string>
 <key>NSLocationWhenInUseUsageDescription</key>
 <string>以便获取附近的商品信息</string>
 <key>NSMicrophoneUsageDescription</key>
 <string>以便发送语音</string>
 <key>NSPhotoLibraryAddUsageDescription</key>
 <string>以便保存图片</string>
 <key>NSPhotoLibraryUsageDescription</key>
 <string>以便选取相册中的图片</string>
*/
